...
class Googlemaps {
	...
	var $apiKey						= 'AIzaSyDi8pAFaNLoQPDgUaeH9tg4sN1G3jRc50o'; 						// If you've got an API key you can use it by passing this parameter. Setup an API key here: https://code.google.com/apis/console
